Namespace StoryManage.View
    ...
    Partial Class Fr_Story
        ...
        Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Fr_Story))
            ...
            'ShieldBox
            '
            Me.ShieldBox.EditValue = "显示未屏蔽记录"
            ...
            Me.ShieldBox.Properties.Items.AddRange(New Object() {"显示全部记录", "显示已屏蔽记录", "显示未屏蔽记录"})
