...
#Region "IDataAccess 成员"
        ...
        '准备Command
        Private Sub PrepareCommand(ByVal cmd As MySqlCommand, ByVal commandType As CommandType, ByVal commandText As String, ByVal commandQueryParameter As QueryParameter())
