...
Namespace Utils.Database.Impl
    Public Class AccessImpl
        ...
        '数据库连接属性
        Property Conn() As OleDbConnection
        '数据库事务属性
        Property Tran() As OleDbTransaction
...
#Region "IDataAccess 成员"
        ...
        '准备Command
        Private Sub PrepareCommand(ByVal cmd As OleDbCommand, ByVal commandType As CommandType, ByVal commandText As String, ByVal commandQueryParameter As QueryParameter())
